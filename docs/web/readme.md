...
```bash
$ npm install -g cnpm --registry=http://www.yuanzhian.com:7001
```

Or you can alias NPM to use it:

```bash
alias cnpm="npm --registry=http://www.yuanzhian.com:7001 \
...
```bash
$ open http://www.yuanzhian.com:7002/sync/connect
```
